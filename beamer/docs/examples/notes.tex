...
\hypersetup{
  pdftitle={Notes and handouts in rst2beamer},
}
...
% Document title
\title[Notes and handouts in rst2beamer]{Notes and handouts in rst2beamer%
  \label{notes-and-handouts-in-rst2beamer}}
\author[]{}
\date{}
\maketitle
...
%
\begin{quote}{\ttfamily \raggedright \noindent
rst2beamer~-{}-shownotes~true~notes.rst~notes\_shownotes\_true.tex
}
\end{quote}
\setbeamerfont{quote}{parent=quotation}
...
%
\begin{quote}{\ttfamily \raggedright \noindent
rst2beamer~-{}-shownotes~only~notes.rst~notes\_shownotes\_only.tex
}
\end{quote}
\setbeamerfont{quote}{parent=quotation}
...
\begin{frame}[fragile]
\frametitle{Showing notes}


Beamer (and rst2beamer) support the inclusion of notes in a presentation. By default, these won't show up in the generated presentation unless requested. The appearance of notes is set with the commandline argument \texttt{-{}-shownotes}. For example:
\setbeamerfont{quote}{parent={}}
%
\begin{quote}{\ttfamily \raggedright \noindent
...
show notes as per \texttt{right}

\item[{only}] \leavevmode 
show only the notes, not the presentation

\item[{left, right, top, bottom}] \leavevmode 
...
\begin{frame}[fragile]
\frametitle{The note directive}


Notes can be included with the \texttt{beamer-note} directive.
\note{
